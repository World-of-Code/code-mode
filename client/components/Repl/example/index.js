...
//     //   console.log(\"i\'ve loaded\");
//     // }`;
//     //console.log('hello ', typeof defaultValue)
...
//   }
//   componentDidMount () {
//     // this.props.handleInputFetch().then(res => this.setState({
//     //   value: res[0].text
//     // }))
//     this.props.handleInputFetch()
//     //console.log('hi ', this.props.handleInputFetch())
//     // this.setState({
//     //   value: this.props.input && this.props.input[0].text
//     // })
  
    
//   }
//   render() {
//     //console.log('hello ', this.props.input[0])
//     //if (this.props.input[0] !== undefined){console.log('hello ', this.props.input[0].text)}
//     //const inputValue = this.props.input[0] ? eval('`' +this.props.input[0].text+'`') : ''
//     //console.log('hello ', this.props.input)
//     //console.log('hello ', this.state.value)
//     const inputValue = this.props.input[0] ? this.props.input[0].text : ''
//     //console.log('hello ', inputValue)
    
//     // this.setState({
//     //   value: inputValue
//     // })
//     console.log('hi ', this.props.input)
//     // let old = console.log;
//     // let logger;  
//     //   console.log = ()=>{
