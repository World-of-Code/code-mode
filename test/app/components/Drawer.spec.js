...
import Drawer from '../../../client/components/Drawer/Drawer.js';
...
describe('ReactDrawer', () => {
  ...
  it('should display an overlay and a drawer', () => {
    ...
    expect(wrapper.find('.drawer-overlay').length).toBe(1);
    expect(wrapper.find('.drawer-drawer').length).toBe(1);
  });
  it('with noOverlay should display a drawer', () => {
    const wrapper = shallow(
      <ReactDrawer open noOverlay />
    );
    expect(wrapper.find('.drawer-overlay').length).toBe(0);
    expect(wrapper.find('.drawer-drawer').length).toBe(1);
  });
  ...
  it('should getOverlayClassName return class', () => {
    ...
    expect(c.indexOf('drawer-overlay')).not.toBe(-1);
  ...
  it('should getDrawerClassName return class', () => {
    ...
    expect(c.indexOf('drawer-drawer')).not.toBe(-1);
